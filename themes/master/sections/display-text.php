...
<section class="<?= $section_settings['spacing_top']; ?> <?= $section_settings['spacing_bottom']; ?> flex flex-col pl-6 pr-6 lg:pl-0 lg:pr-0 section-displaytext lg:justify-center">
